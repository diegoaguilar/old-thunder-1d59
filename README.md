...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/old-thunder-1d59
```

A live public deployment of this template is available at [https://old-thunder-1d59.templates.workers.dev](https://old-thunder-1d59.templates.workers.dev)
